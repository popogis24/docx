...
sheet_name = "guaxuma1"  # Substitua pelo nome da planilha que deseja converter
...
for pdf in range(len(list_pdf)):
    ...
    VALOR_TERRANUA_fl = float(AREA_TOTAL) * 10830
    ...
    doc = docx.Document(fr'C:\Users\Ander\OneDrive\Documentos\JORGE_DOCUMENTOS\Modelo_Guaxuma.docx')
    #salva esse arquivo com o nome do pdf
    doc.save(fr'C:\Users\Ander\OneDrive\Documentos\JORGE_DOCUMENTOS\GUAXUMA\DOC_Atualizados\{nome_pdf}.docx')
    #abre esse arquivo usando o 
    doc = DocxTemplate(fr'C:\Users\Ander\OneDrive\Documentos\JORGE_DOCUMENTOS\GUAXUMA\DOC_Atualizados\{nome_pdf}.docx')
    ...
    #FECHA O DOCUMENTO
    doc = None
    print(TITULO_PRINCIPAL, VALOR_TERRANUA)
